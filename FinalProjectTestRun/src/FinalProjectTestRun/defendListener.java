...
/**
 * Listener for the defendButton
 */
public class defendListener implements ActionListener, MouseListener
{
    ...
    public defendListener(JLabel newLabel, Hero newHero, Monster newMonster, FinalProjectTester newWindow)
    {
        super();
    ...
    {
        myLabel.setText("Halves incoming damage");
    }
    ...
    /**
     * Causes the Hero to defend against the next attack when
