...
/**
 * Listener for the skillButton2
 */
public class skill2Listener implements ActionListener, MouseListener
{
    ...
    public skill2Listener(JLabel newLabel, Hero newHero, Monster newMonster, FinalProjectTester newWindow)
    {
        super();
    ...
    {
        myLabel.setText("Attacks 2x. Cost: 3 SP");
    }
    ...
    /**
     * Causes the Hero use the skill Double Strike when
