...
/**
 * Listener for the skillButton1
 */
public class skill1Listener implements ActionListener, MouseListener
{
    ...
    public skill1Listener(JLabel newLabel, Hero newHero, Monster newMonster, FinalProjectTester newWindow)
    {
        super();
    ...
    {
        myLabel.setText("Heals. Cost: 2 SP.");
    }
    ...
    /**
     * Causes the Hero use the skill Healing Spray when
